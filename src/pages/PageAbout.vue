      ...
      <q-list>
        <q-item>
          <q-item-section>
            ...
            <q-item-label>HTML5, CSS 3, JavaScript, JQuery</q-item-label>
          </q-item-section>
        </q-item>
        <q-item>
          <q-item-section>
            <q-item-label overline>UI Frameworks/Libraries</q-item-label>
            <q-item-label>Bootstrap, Tailwind CSS</q-item-label>
          </q-item-section>
        </q-item>
        <q-item>
          <q-item-section>
            <q-item-label overline>Vue.js</q-item-label>
            <q-item-label>
              Vue 2, Vue 3, Vue-CLI, Vuex, Vuetify, Vuepress, Gridsome, Quasar
            </q-item-label>
          </q-item-section>
        </q-item>
        <q-item>
        ...
        <q-item>
          <q-item-section>
            <q-item-label overline>Databases</q-item-label>
            <q-item-label>
        ...
        <q-item>
          <q-item-section>
            <q-item-label overline>Version Control</q-item-label>
            <q-item-label>
              Git, GitHub
            </q-item-label>
          </q-item-section>
        ...
        <q-item>
          <q-item-section>
            <q-item-label overline>Deployment</q-item-label>
            <q-item-label>
              Heroku, Netlify, Firebase, GitHub-Pages
            </q-item-label>
          </q-item-section>
        </q-item>
      </q-list>
